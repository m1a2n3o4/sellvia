...
import { Search, Send, Bot, User, Building2, RefreshCw, Check, CheckCheck, Image as ImageIcon, Package, ArrowLeft } from 'lucide-react';
        ...
        {loading ? (
          ...
          chats.map((chat) => (
            <button
              ...
              className={cn(
                'w-full text-left px-4 py-3 border-b border-neutral-100 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors active:bg-neutral-100',
